(function(){
  const memories=[
    {id:'military',title:'初见 · 军训场',note:'从陌生走向同频',src:'assets/military.jpg',ratio:.75,coverZoom:1.13,memoryPath:'memory-inners/01-military/'},
    {id:'library',title:'进入 · 图书馆前',note:'一座楼，许多人的一天',src:'assets/library.jpg',ratio:1.33,memoryPath:'memory-inners/generic/?scene=library'},
    {id:'video-learning-building',title:'仰望 · 博学楼',note:'镜头向上，时间从楼面掠过',src:'assets/campus-memory-2-poster.png',ratio:.5625,video:true,memoryPath:'memory-inners/generic/?scene=video-learning-building'},
    {id:'stairs-a',title:'经过 · 楼梯间',note:'阳光沿着扶手向上',src:'assets/stairs-wide.jpg',ratio:.81,memoryPath:'memory-inners/04-stairs-light/'},
    {id:'stairs-sun',title:'下楼 · 午间光影',note:'脚步穿过一格一格的阳光',src:'assets/stairs-sun.jpg',ratio:.75,memoryPath:'memory-inners/generic/?scene=stairs-sun'},
    {id:'classroom',title:'共同 · 阶梯教室',note:'一排座位等待被坐满',src:'assets/classroom.jpg',ratio:2.13,memoryPath:'memory-inners/generic/?scene=classroom'},
    {id:'classroom-autumn',title:'窗边 · 秋日教室',note:'树叶替我们记住季节',src:'assets/classroom-autumn.jpg',ratio:1.33,memoryPath:'memory-inners/generic/?scene=classroom-autumn'},
    {id:'cafeteria',title:'午后 · 食堂',note:'阳光落在我们坐过的位置',src:'assets/cafeteria.jpg',ratio:1.53,memoryPath:'memory-inners/generic/?scene=cafeteria'},
    {id:'video-red-building',title:'环行 · 红砖楼前',note:'阳光沿弧形屋檐缓慢移动',src:'assets/campus-memory-3-poster.png',ratio:1.78,video:true,memoryPath:'memory-inners/generic/?scene=video-red-building'},
    {id:'coffee-corner',title:'停留 · 小白房子',note:'一杯咖啡的安静时间',src:'assets/coffee-corner.jpg',ratio:.75,memoryPath:'memory-inners/generic/?scene=coffee-corner'},
    {id:'campus-cat',title:'遇见 · 校园猫',note:'它也在这里度过午后',src:'assets/campus-cat.jpg',ratio:.75,memoryPath:'memory-inners/generic/?scene=campus-cat'},
    {id:'tulips',title:'春日 · 花开',note:'颜色在校园里醒来',src:'assets/tulips.jpg',ratio:1.33,memoryPath:'memory-inners/generic/?scene=tulips'},
    {id:'spring-road',title:'春天 · 林荫路',note:'我们从新绿下面走过',src:'assets/spring-road.jpg',ratio:.75,memoryPath:'memory-inners/generic/?scene=spring-road'},
    {id:'sunset',title:'黄昏 · 林荫小路',note:'阳光又从树影里活过来了',src:'assets/campus-sunset.jpg',ratio:.76,memoryPath:'memory-inners/generic/?scene=sunset'},
    {id:'autumn-road',title:'深秋 · 树影',note:'季节把路染成金色',src:'assets/autumn-road.jpg',ratio:1.33,memoryPath:'memory-inners/generic/?scene=autumn-road'},
    {id:'ginkgo-road',title:'同行 · 银杏路',note:'两个人走进同一个秋天',src:'assets/ginkgo-road.jpg',ratio:1.33,memoryPath:'memory-inners/generic/?scene=ginkgo-road'},
    {id:'tree-tunnel',title:'经过 · 树下',note:'一条每天都会经过的路',src:'assets/tree-tunnel.jpg',ratio:.75,memoryPath:'memory-inners/generic/?scene=tree-tunnel'},
    {id:'snow-road',title:'冬日 · 初雪',note:'脚印继续向前',src:'assets/snow-road.jpg',ratio:.75,memoryPath:'memory-inners/generic/?scene=snow-road'},
    {id:'road',title:'擦肩 · 校园日常',note:'每个人都在构成校园',src:'assets/campus-road.jpg',ratio:2.64,memoryPath:'memory-inners/generic/?scene=road'},
    {id:'video-campus-walk',title:'经过 · 放学路上',note:'脚步把普通一天带向前',src:'assets/campus-memory-4-poster.png',ratio:1.78,video:true,memoryPath:'memory-inners/generic/?scene=video-campus-walk'},
    {id:'video-teaching-building',title:'转身 · 教学楼前',note:'光从树影移向玻璃幕墙',src:'assets/campus-memory-5-poster.png',ratio:1.78,video:true,memoryPath:'memory-inners/generic/?scene=video-teaching-building'},
    {id:'video-memory',title:'流动 · 雨中同行',note:'这一帧仍在继续发生',src:'assets/campus-memory-poster.jpg',ratio:1.78,video:true,memoryPath:'memory-inners/generic/?scene=video-memory'},
    {id:'graduation',title:'毕业 · 操场',note:'毕业不是时间河的终点',src:'assets/graduation.jpg',ratio:1.41,coverZoom:1.22,memoryPath:'memory-inners/generic/?scene=graduation'},
